...
from . import oge_exception, _cloud_api_utils
...
class Serializer(object):
    ...
    """
        ...
        if self._is_compound and encoded:
            ...
            raise oge_exception.OGException('Can\'t encode object: %s' % obj)
...
def encode(obj, is_compound=True, for_cloud_api=True, unbound_name=None):
    """cSerialize an object to a JSON-compatible structure for API alls.
