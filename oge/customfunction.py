...
class CustomFunction(function.Function, encodable.Encodable):
    ...
    """
        ...
        if body(*variables) is None:
            raise oge_exception.OGException('User-defined methods must return a value')
    ...
    """
        var_type = oge_types.nameToClass(type_name) or computedobject.ComputedObject
    ...
    """
        ...
        def StringifyType(t):
            return t if isinstance(t, six.string_types) else oge_types.classToName(t)
    ...
    """
        ...
        # within the body. 获取该输入参数所对应函数所在的层级，最里层为0
        ...
        # Update the vars and signature by the name. i表示是第几个参数
